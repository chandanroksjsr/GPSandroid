...
public class TermsAndConditionTab extends Activity {
	TextView warantydis, expect, deemgpsreturn, deemgpsrefund, deemgpswarranty,
			inwarantyrepairs, inwarantyservice, outofwaranty, brokendisplay,
			shippingins, shipins, deemsindianaddrs;
