...
public class AboutusTab extends Activity
{
	...
	TextView ourdevice,vehtrac,perstrack,watchtrack,mygps,support,indianad,usadd,corplink,rajanemail,salesemail,aboutdee,corpweb,aboutdeemapp,deemgpweb;
	 @Override
	  public void onCreate(Bundle savedInstanceState)
	    {
	      ...
	      rajanemail.setOnClickListener(new OnClickListener() {               
	          public void onClick(View arg0) {
	              sendEmail(context, new String[]{"rajan@deemsysinc.com"}, "Sending Email",
	                        "GPS V_1.0 on Android", "");
	          }
	      });
	      ...
	      salesemail.setOnClickListener(new OnClickListener() {               
	          public void onClick(View arg0) {
	              sendEmail(context, new String[]{"sales@deemsysinc.com"}, "Sending Email",
	                        "GPS V_1.0 on Android", "");
	          }
	      });
